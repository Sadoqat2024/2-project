  ...
  return (
    <div className="bg-black/70 w-full lg:w-[1366] lg:h-[690] lg:px-8 h-auto ">
      <div className="flex flex-col lg:flex-row">
        {/*main 1*/}
        <div className="w-full lg:w-1/2 md:w-1/3 lg:flex  lg:mb-0 p-5 relative mb-8">
          <div className="m-20 relative inline-block rounded overflow-hidden">
            <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/10 to-black/70"></div>
        ...
        <div className="md:flex lg:w-1/2 md:w-1/3  flex-wrap justify-end items-center gap-3">
          <div className="w-full  lg:w-[450px] h-[335px]  bg-sky-200 flex m-10 ml-40 md:mr-20 md:m-0 relative">
            <div className="md:flex flex-row space-y-3">
              <div className="ml-5">
              ...
              <img
                className="w-full md:w-60 h-80 mt-10 scale object-cover rounded-lg"
