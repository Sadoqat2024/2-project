...
const HomePage = () => {
  return (
    <div className='home-back '>
      <div>
      <div className='lg:flex items-center justify-between border-none h-24 mt-5 mb-3 rounded-md px-9 ml-40 mr-40 bg-slate-950'>
     ...
     {/*img section*/}
      <section className='w-3/4 flex space-x-0 ml-36 px-6 justify-between '>
        
          <div className='relative ml-30 z-10 rounded-l-lg  inline-block rounded overflow-hidden'>
        ...
        <div className='absolute top-20 left-10 z-20 m-3 flex justify-between flex-col space-x-14'>
          ...
          <div className='w-1/4 px-2 mb-5 block bg-slate-100'>
